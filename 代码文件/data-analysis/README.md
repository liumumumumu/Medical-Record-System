...
组内交接说明统一保存在 [`docs/project/team-collaboration.md`](../../docs/project/team-collaboration.md)，不再依赖个人电脑绝对路径。
...
- 数据模块负责附件状态标准化；在线后端会提取 PDF、DOC、DOCX 文本，图片在未配置 OCR 时明确标记为仅元数据。
